...
class ActorViewModel extends ViewModel
{
    ...
    public function knownForMovies() {
        ...
        return collect($castMovies)->where("media_type", "movie")->sortByDesc("popularity")->take(3)->union(
            collect($castMovies)->where("media_type", "tv")->sortByDesc("popularity")->take(2)
        )->map(function($movie) {
    ...
    public function credits() {
        ...
        return collect($castMovies)->map(function($movie) {
            ...
            return collect($movie)->merge([
                ...
                'release_date', 'release_year', 'title', 'character', "id", "linkToPage",
            ]);
